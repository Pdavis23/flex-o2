...
/**
 * Removes all comment related functionality and admin views if the
 * GRANOLA_DISABLE_COMMENTS constant is true.
 */
class Comments
{
    public static function init(): void
    {
        if (!defined('GRANOLA_DISABLE_COMMENTS') || GRANOLA_DISABLE_COMMENTS !== true) {
            return;
        }
    ...
    {
        return defined('GRANOLA_COMMENTS')
            && GRANOLA_COMMENTS === true
            && \is_singular()
            && \comments_open()
