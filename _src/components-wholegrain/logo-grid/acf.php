...
acf_register_block_type([
    'name' => 'logo-grid', // Name/key, alphanumeric characters and dashes only.
    'title' =>  'Logo grid', // Label in block editor.
    'description' => 'A logo grid block', // A short description.
    'category' => 'granola-blocks', // Core: common | formatting | layout | widgets | embed.
    'icon' => 'image-flip-horizontal', // https://developer.wordpress.org/resource/dashicons/
    ...
    'render_callback' => function ($block, $content, $is_preview, $post_id) {
        ...
        echo \Granola\Component::get('logo-grid', $args);
    }
]);
