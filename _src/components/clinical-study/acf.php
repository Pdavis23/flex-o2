...
acf_register_block_type([
    'name' => 'clinical-study', // Name/key, alphanumeric characters and dashes only.
    'title' =>  'Clinical Study', // Label in block editor.
    ...
    'supports' => [
        'align' => ['wide'], // Block alignment choices. 'false' to hide all.
        // 'align_text' => true,
    ...
    'render_callback' => function ($block, $content, $is_preview, $post_id) {
        ...
        echo \Granola\Component::get('clinical-study', $args);
    }
]);
