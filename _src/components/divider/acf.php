...
acf_register_block_type([
    'name' => 'divider', // Name/key, alphanumeric characters and dashes only.
    'title' =>  'Divider', // Label in block editor.
    // 'description' => '', // A short description.
    'category' => 'granola-blocks', // Core: common | formatting | layout | widgets | embed.
    'icon' => 'tide', // https://developer.wordpress.org/resource/dashicons/
    ...
    'render_callback' => function ($block, $content, $is_preview, $post_id) {
        ...
        echo \Granola\Component::get('divider', $args);
    }
]);
