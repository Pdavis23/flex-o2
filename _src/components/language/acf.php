...
acf_register_block_type([
    'name' => 'language', // Name/key, alphanumeric characters and dashes only.
    'title' =>  'Language', // Label in block editor.
    ...
    'align' => false, // Default block alignment: wide | full | center | left | right.
    ...
    'render_callback' => function ($block, $content, $is_preview, $post_id) {
        ...
        echo \Granola\Component::get('language', $args);
    }
]);
