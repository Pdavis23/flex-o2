...
acf_register_block_type([
    'name' => 'statistic', // Name/key, alphanumeric characters and dashes only.
    'title' =>  'Statistic', // Label in block editor.
    // 'description' => '', // A short description.
    'category' => 'granola-blocks', // Core: common | formatting | layout | widgets | embed.
    'icon' => 'chart-bar', // https://developer.wordpress.org/resource/dashicons/
    ...
    'render_callback' => function ($block, $content, $is_preview, $post_id) {
        ...
        echo \Granola\Component::get('statistic', $args);
    }
]);
